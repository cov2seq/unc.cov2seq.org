...
function init() {
  ...
  document.getElementById("report_date").innerText = "September 30, 2022";
  document.getElementById("sample_date").innerText = "September 21, 2022";
  loadText("220930.meta_simple.tsv", function(content) {
    temp = [];
