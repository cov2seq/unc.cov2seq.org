...
function init() {
  ...
  document.getElementById("report_date").innerText = "September 19, 2022";
  document.getElementById("sample_date").innerText = "September 8, 2022";
  loadText("220919.meta_simple.tsv", function(content) {
    temp = [];
