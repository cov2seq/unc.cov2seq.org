...
function init() {
  ...
  document.getElementById("report_date").innerText = "September 9, 2022";
  document.getElementById("sample_date").innerText = "August 31, 2022";
  loadText("220909.meta_simple.tsv", function(content) {
    temp = [];
