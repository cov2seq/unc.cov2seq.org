...
function init() {
  ...
  document.getElementById("report_date").innerText = "June 10, 2022";
  document.getElementById("sample_date").innerText = "June 1, 2022";
  loadText("220610.meta_simple.tsv", function(content) {
    temp = [];
