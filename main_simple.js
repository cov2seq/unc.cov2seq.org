...
function init() {
  ...
  document.getElementById("report_date").innerText = "May 28, 2022";
  document.getElementById("sample_date").innerText = "May 19, 2022";
  loadText("220528.meta_simple.tsv", function(content) {
    temp = [];
