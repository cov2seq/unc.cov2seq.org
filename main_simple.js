...
function init() {
  ...
  document.getElementById("report_date").innerText = "April 15, 2022";
  document.getElementById("sample_date").innerText = "April 6, 2022";
  loadText("220415.meta_simple.tsv", function(content) {
    temp = [];
