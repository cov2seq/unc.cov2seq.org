...
function init() {
  ...
  document.getElementById("report_date").innerText = "September 23, 2022";
  document.getElementById("sample_date").innerText = "September 14, 2022";
  loadText("220923.meta_simple.tsv", function(content) {
    temp = [];
