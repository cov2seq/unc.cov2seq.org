...
function init() {
  ...
  document.getElementById("report_date").innerText = "July 15, 2022";
  document.getElementById("sample_date").innerText = "July 7, 2022";
  loadText("220715.meta_simple.tsv", function(content) {
    temp = [];
