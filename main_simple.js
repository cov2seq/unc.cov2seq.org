...
function init() {
  ...
  document.getElementById("report_date").innerText = "June 17, 2022";
  document.getElementById("sample_date").innerText = "June 8, 2022";
  loadText("220617.meta_simple.tsv", function(content) {
    temp = [];
