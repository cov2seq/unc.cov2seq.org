...
function init() {
  ...
  document.getElementById("report_date").innerText = "July 22, 2022";
  document.getElementById("sample_date").innerText = "July 13, 2022";
  loadText("220722.meta_simple.tsv", function(content) {
    temp = [];
