...
function init() {
  ...
  document.getElementById("report_date").innerText = "June 24, 2022";
  document.getElementById("sample_date").innerText = "June 15, 2022";
  loadText("220624.meta_simple.tsv", function(content) {
    temp = [];
