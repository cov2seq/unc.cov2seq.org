...
function init() {
  ...
  document.getElementById("report_date").innerText = "June 2, 2022";
  document.getElementById("sample_date").innerText = "May 25, 2022";
  loadText("220602.meta_simple.tsv", function(content) {
    temp = [];
