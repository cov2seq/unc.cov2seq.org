...
function init() {
  document.getElementById("report_date").innerText = "April 21, 2023";
  document.getElementById("sample_date").innerText = "April 2, 2023";
  loadText("230421.meta_simple.tsv", function(content) {
    temp = [];
