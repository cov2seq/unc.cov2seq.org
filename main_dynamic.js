...
function init() {
  document.getElementById("report_date").innerText = "December 15, 2022";
  document.getElementById("sample_date").innerText = "December 7, 2022";
  loadText("221215.meta_simple.tsv", function(content) {
    temp = [];
