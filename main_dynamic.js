...
function init() {
  document.getElementById("report_date").innerText = "March 1, 2023";
  document.getElementById("sample_date").innerText = "February 18, 2023";
  loadText("230301.meta_simple.tsv", function(content) {
    temp = [];
