...
function init() {
  document.getElementById("report_date").innerText = "December 9, 2022";
  document.getElementById("sample_date").innerText = "November 30, 2022";
  loadText("221209.meta_simple.tsv", function(content) {
    temp = [];
