...
function init() {
  document.getElementById("report_date").innerText = "December 26, 2022";
  document.getElementById("sample_date").innerText = "December 17, 2022";
  loadText("221226.meta_simple.tsv", function(content) {
    temp = [];
