...
function init() {
  document.getElementById("report_date").innerText = "February 15, 2023";
  document.getElementById("sample_date").innerText = "February 5, 2023";
  loadText("230215.meta_simple.tsv", function(content) {
    temp = [];
